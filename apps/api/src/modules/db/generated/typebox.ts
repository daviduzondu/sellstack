...
export const Currency = Type.Union([Type.Literal('NGN'), Type.Literal('USD')]);
...
export const Accounts = Type.Object({
  ...
  accessTokenExpiresAt: Type.Union([Type.Date(), Type.Null()]),
  ...
  refreshTokenExpiresAt: Type.Union([Type.Date(), Type.Null()]),
...
export const Products = Type.Object({
  ...
  name: Type.String(),
  shortDecription: Type.Union([Type.String(), Type.Null()]),
...
export const ProductVariants = Type.Object({
  ...
  minPrice: Type.Union([Type.String(), Type.Null()]),
  name: Type.String(),
  price: Type.String(),
